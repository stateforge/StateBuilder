 ...
 * @author frederic
 */
public class LicensingInfo implements LicenseableClass {
    ...
    private static String keystoreFilename = "StateBuilderCppPublicKeyStore";
    ...
    private static String alias = "StateBuilderCpp";
    ...
    private static String ftpAlias = "StateBuilderCppFtp";
    ...
    public void handleLicenseTrialPeriodValid(){
        //Logger.getLogger(StateBuilder.class.getName()).log(Level.INFO,"");
    }
